        ...
        function () {
            ...
            Route::prefix('invoice')->group(
                function () {
                    ...
                    Route::get('/download/{id}', [InvoiceController::class, 'downloadInvoice'])->name('downloadInvoice');
                }
            );
            ...
            Route::prefix('user')->group(
                function () {
                    ...
                    Route::post('add', [UserController::class, 'postadd'])->name('postAddUser');
                    Route::get('edit/{id?}', [UserController::class, 'edit'])->name('editUser')->where(['id' => '[0-9]+']);
                    Route::put('edit', [UserController::class, 'postedit'])->name('postEditUser');
                }
            );
        }
    );
