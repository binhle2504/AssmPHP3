            ...
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                <div class="product-image">
                    <div class="product_img_box">
                        <img id="" src='{{ asset('assets/clients/uploads/product/') . '/' . $data->pimage }}'
            ...
            <div class="col-lg-6 col-md-6">
                <div class="pr_detail">
                    ...
                    <div class="d-block product_sort_info">
                        <ul>
                            <li><i class="ti-bookmark"></i>Đảm Bảo Chất Lượng !</li>
                            <li><i class="ti-truck"></i> Giao Hàng Tận Cổng Nhà Bạn !</li>
                            <li><i class="ti-gift"></i> Ưu Đãi Hấp Dẫn !</li>
                        </ul>
                    </div>
                    <hr />
                    <div class="cart_extra">
                        ...
                        <div class="form-submit cart_btn">
                            ...
                            <button class="addItemBtn2 btn btn-fill-out " type="button"><i
                                    class="ti-shopping-cart-full"></i>Thêm vào giỏ hàng</button>
                        </div>
                    </div>
                    <hr />
                    <ul class="product-meta">
                        <li>Mã Sản Phẩm: <a href="#">SKU{{$data->id}}</a></li>
                        <li>Danh Mục: <a
                                href="{{ route('category/{slug}', ['slug' => $data->slug]) }}">{{ $data->name }}</a>
                        </li>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="Additional-info-tab" data-bs-toggle="tab" href="#Additional-info"
                                role="tab" aria-controls="Additional-info" aria-selected="false">Thông tin sản phẩm</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="Reviews-tab" data-bs-toggle="tab" href="#Reviews" role="tab"
                                aria-controls="Reviews" aria-selected="false">Đánh giá (2)</a>
                        </li>
                    </ul>
                        ...
                        <div class="product">
                            <div class="product_img">
                                <a href="{{ route('product/{slug}', ['slug' => $row->slug]) }}">
                                    <img src="{{ asset('assets/clients/uploads/product/') . '/' . $row->image }}"
                                        alt="product_img1">
                                </a>
                            </div>
                            <div class="product_info">
                                <h6 class="product_title"><a
                                        href="{{ route('product/{slug}', ['slug' => $row->slug]) }}">{{ $row->name }}</a>
                                </h6>
                                <div class="product_price">
