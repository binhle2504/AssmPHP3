                            ...
                            <div class="col-lg-7 col-9">
                                <div class="banner_content overflow-hidden">
                                    <h5 class="mb-3 staggered-animation font-weight-light" data-animation="slideInLeft"
                                        data-animation-delay="0.5s">{{$row->description}}</h5>
            ...
            <div class="col-12">
                <ul class="nav nav-tabs justify-content-start" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" id="sellers-tab" data-bs-toggle="tab" href="#sellers" role="tab"
                            aria-controls="sellers" aria-selected="false"><i class="ti-filter">Sản Phẩm Mới Nhất</i></a>
                    </li>
                </ul>
                <!-- lọc sản phẩm  -->
                <!-- <div class="tab-style1">
                    <ul class="nav nav-tabs justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="arrival-tab" data-bs-toggle="tab" href="#arrival" role="tab" aria-controls="arrival" aria-selected="true">Tất cả</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="sellers-tab" data-bs-toggle="tab" href="#sellers" role="tab" aria-controls="sellers" aria-selected="false">Mới nhất</a>
                        </li>
                    </ul>
                </div> -->
                                ...
                                <div class="product">
                                    <div class="product_img">
                                        <a href="{{ route('product/{slug}', ['slug' => $product->slug]) }}">
                                            <img src="{{ asset('assets/clients/uploads/product/') . '/' . $product->image }}"
                                                alt="product_img1">
                                        </a>
                                    </div>
                                    <div class="product_info">
                                        ...
                                        <div class="product_price">
                                            <span class="price">{{ Helper::format_number($product->price) }}đ</span>
                                        </div>
                                        <div class="">
                                            <button class="addItemBtn2 btn btn-fill-out " type="button"><i
                                                    class="ti-shopping-cart-full"></i>+1</button>
                                        </div>
            ...
            <div class="col-md-6">
                <div class="single_banner">
                    ...
                    <div class="single_banner_info">
                        ...
                        <!-- <a href="{{ route('category/{slug}', ['slug' => $row->slug]) }}" class="single_bn_link">Xem
                            ngay</a> -->
                    </div>
                </div>
            </div>
    ...
    <div class="product">
        <div class="product_img">
            <a href="shop-product-detail.html">
                <img src="{{ asset('assets/clients/images/product_img1.jpg') }}" alt="product_img1">
            </a>
...
<div class="item">
    <div class="product">
        <div class="product_img">
            <a href="shop-product-detail.html">
                <img src="{{ asset('assets/clients/images/product_img2.jpg') }}" alt="product_img2">
            </a>
            <div class="product_action_box">
                <ul class="list_none pr_action_btn">
                    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
...
<div class="item">
    <div class="product">
        ...
        <div class="product_img">
            <a href="shop-product-detail.html">
                <img src="{{ asset('assets/clients/images/product_img3.jpg') }}" alt="product_img3">
            </a>
            <div class="product_action_box">
                <ul class="list_none pr_action_btn">
                    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
...
<div class="item">
    <div class="product">
        <div class="product_img">
            <a href="shop-product-detail.html">
                <img src="{{ asset('assets/clients/images/product_img4.jpg') }}" alt="product_img4">
            </a>
            <div class="product_action_box">
                <ul class="list_none pr_action_btn">
                    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
...
<div class="item">
    <div class="product">
        <div class="product_img">
            <a href="shop-product-detail.html">
                <img src="{{ asset('assets/clients/images/product_img5.jpg') }}" alt="product_img5">
            </a>
            <div class="product_action_box">
                <ul class="list_none pr_action_btn">
                    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
            ...
            <div class="col-lg-4">
                <div class="icon_box icon_box_style1">
                    ...
                    <div class="icon_box_content">
                        <h5>Đội Ngũ Hỗ Trợ 24/7</h5>
                        <p>Bất kể khi nào bạn cần hãy điện ngay cho chúng tôi !</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="icon_box icon_box_style1">
                    ...
                    <div class="icon_box_content">
                        ...
                        <p>Nếu Bạn Ở Xa , Hãy Ngủ Ngon Và Để Chúng Tôi Lo!</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="icon_box icon_box_style1">
                    ...
                    <div class="icon_box_content">
                        <h5>Hỗ Trợ Đổi Trả Trong 30 Ngày</h5>
                        <p>Chúng tôi hỗ trợ đổi trả với sản phẩm lỗi do nhà sản xuất trong vòng 30 ngày</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="heading_s1 mb-md-0 heading_light">
                    <h3>Nhận Gmail Về Sản Phẩm Mới Nhất</h3>
                </div>
            </div>
            <div class="col-md-6">
                <div class="newsletter_form">
                    <form>
                        <input type="text" required="" class="form-control rounded-0" placeholder="Nhập Gmail Của Bạn">
                        <button type="submit" class="btn btn-dark rounded-0" name="submit" value="Submit">Đăng
                            Ký</button>
                    </form>
                </div>
            </div>
