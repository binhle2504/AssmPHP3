                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.postAddProduct') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <!-- editor1 => thêm cái này vào id trong textarae đêr thêm các chức năng  -->
                                <div class="row mb-3">
                                    <div class="col">
                                        <label>Trạng thái</label>
                                        <div class="m-t-10 m-checkbox-inline custom-radio-ml">
                                            <div class="form-check form-check-inline radio radio-primary">
                                                <input class="form-check-input" id="status" type="radio" name="status"
                                                    value="1" checked>
                                ...
                                <div class="form-group">
                                    <label for="example-email">Hình ảnh mô tả </label>
                                    <div class="input-group">
