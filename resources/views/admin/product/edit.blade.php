                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="validationCustom02" class="col-form-label">
                                        Số lượng</label>
                                    <input class="form-control" name="amount" type="number" value="{{ $data->amount }}">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="example-email">Mô tả hình ảnh</label>
                                    <div class="input-group">
                                        <input type="file" name="listimg[]" multiple>
                                    </div>
                                    @if ($data->listimg)
                                    @foreach (json_decode($data->listimg) as $image)
                                    <img src="{{ asset('assets/clients/uploads/product/' . $image) }}" id="imagePreview"
                                        width="200px" class="file-preview ml-2" />
                                    @endforeach
                                    @endif
