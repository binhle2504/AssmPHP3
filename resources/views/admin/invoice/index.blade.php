                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a data-toggle="modal" data-target="#standard-{{ $row->id }}"
                                            class="action-icon">
                                            <i class=""></i>Chọn</a>
                                        <!-- <a href="{{ route('admin.downloadInvoice',['id'=>$row->id]) }}"
                                ...
                                <!-- Standard modal -->
                                <div id="standard-{{ $row->id }}" class="modal fade" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-body">
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item">Chi tiết hóa đơn: <a
                                                            href="{{ route('invoice', ['id' => $row->id]) }}">xem</a>
                                                    </li>
                                                </ul>
                                                        ...
                                                        <div class="row w-100">
                                                            ...
                                                            <div class="col-md-4">
                                                                <button type="submit" name="wait"
                                                                    class="btn btn-warning btn-block" value="0">Chưa
                                                                    t.toán</button>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <button type="submit" name="done"
                                                                    class="btn btn-success btn-block" value="1">Thanh
                                                                    toán</button>
                                                            </div>
                                                        </div>
